...
builder.Services.AddScoped<RacaRepositorio, RacaRepositorio>();
builder.Services.AddScoped<IRacaServico, IRacaServico>();
builder.Services.AddScoped<IVeterinarioServico, IVeterinarioServico>();
